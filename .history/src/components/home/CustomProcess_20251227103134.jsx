        ...
        <section className="bg-white py-20  font-sans">
            <div className=" mx-auto">
                ...
                <div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:pl-8 md:py-[60px]  md:flex-row items-stretch mb-20 ">
                    ...
                    <div
                        className="relative w-full md:w-[60%] p-10 mt-9 md:pl-5 md:p-1 flex flex-col justify-center items-start "
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-gray-500 text-sm md:text-base leading-relaxed max-w-xg mb-8">
