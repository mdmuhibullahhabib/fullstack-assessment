...
export default function CustomProcess() {
    ...
    return (
        <section className="bg-white py-20 px-4 font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
   <div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:flex-row items-center mb-20 min-h-[450px]">

  {/* ===== LEFT CONTENT (CENTERED + BG IMAGE) ===== */}
  <div
    className="relative w-full md:w-[60%] px-10 py-14 md:p-16 flex flex-col justify-center items-start"
    style={{
  ...
  >
    ...
    <div className="relative z-10">
      <div className="mb-6">
        <span className="px-5 py-1.5 rounded-full border border-teal-200 text-teal-500 text-[11px] font-bold uppercase tracking-[0.2em] bg-white/70">
          Process
        </span>
      </div>
  ...
  {/* ===== RIGHT IMAGE ===== */}
  <div className="w-full md:w-[40%] flex items-center justify-center py-10">
    <div className="relative w-[85%] h-[360px] md:h-[400px]">
      <Image
        src={rightImage}
