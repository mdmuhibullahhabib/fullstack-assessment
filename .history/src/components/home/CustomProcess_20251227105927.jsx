    ...
    return (
        <section className="bg-white py-20  font-sans">
            <div className=" mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
   <div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:pl-8 md:py-[60px] md:flex-row items-stretch">

    {/* Left Content Box (White with bgImage and Torn Edge) */}
    <div
        className="relative w-full md:w-[60%] p-10 md:pl-5 flex flex-col items-start"
        style={{
    ...
    >
        <div className="ml-16">
            ...
            {/* ✅ Change 1: Paragraph bottom margin কমানো mb-8 → mb-4 */}
            <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-xl mb-4">
            ...
            {/* ✅ Change 2: Button block করা, এবং bottom spacing control */}
            <button className="block border-[1.5px] border-teal-400 text-teal-500 px-8 py-2.5 rounded-md font-bold text-xs hover:bg-teal-500 hover:text-white transition-all">
                Learn More
            </button>
        </div>
    </div>
