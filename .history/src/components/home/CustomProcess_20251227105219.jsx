    ...
    return (
        <section className="bg-white py-20  font-sans">
            <div className=" mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
<div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:flex-row items-stretch mb-20">

  {/* Left Content Box */}
  <div
    className="relative w-full md:w-[60%] p-10 flex flex-col items-start"
    style={{
