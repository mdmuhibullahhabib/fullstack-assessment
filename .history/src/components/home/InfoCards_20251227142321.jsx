...
const InfoCards = () => {
  return (
    <div className="flex flex-col md:flex-row w-full max-w-4xl gap-6 mx-auto font-sans">
      ...
      <div className="flex-1 bg-[#FF4D30] p-8 md:p-10 text-white rounded-lg min-h-[270px] flex flex-col justify-between">
        <div>
      ...
      <div className="flex-1 bg-[#00A99D] p-8 md:p-10 text-white rounded-lg min-h-[270px] flex flex-col justify-between">
        <div>
