...
<div className="relative bg-[#E6F7F8] rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch mb-20 min-h-[480px]">
  ...
  {/* ===== LEFT SIDE (TEXT + BG IMAGE) ===== */}
  <div
    className="relative z-20 w-full md:w-[65%] p-10 md:p-16 flex flex-col justify-center items-start shadow-xl"
    style={{
  ...
  >
    ...
    <span className="inline-block border border-teal-400 text-teal-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 bg-white/70">
      Process
    </span>

    <h2 className="text-3xl md:text-5xl font-extrabold text-slate-800 leading-[1.1] mb-6">
      Do You Want Custom Project With <br className="hidden lg:block" />
  ...
  <div className="w-full md:w-[35%] flex items-center justify-center p-6 md:p-0">
    <div className="relative w-full h-[320px] md:h-[450px] md:scale-110">
      <Image
        src={rightImage}
