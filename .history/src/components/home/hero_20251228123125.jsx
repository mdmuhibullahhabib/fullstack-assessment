      ...
      <div className="relative max-w-7xl mx-auto px-4 py-28 grid md:grid-cols-2 gap-10">
        <div>
          ...
          <p className="text-gray-300 mb-6">
            At Zaheen Knitwear Ltd. We pride ourselves on being your reliable partner for apparal production.Out commitment to ethical manufacturing ensures that every
          </p>
