...
const InfoCards = () => {
  return (
    <div className="md:absolute flex justify-center item-center mx-auto md:ml-[700px] md:mt-[-130px] flex flex-col md:flex-row w-full max-w-4xl mx-auto font-sans">
