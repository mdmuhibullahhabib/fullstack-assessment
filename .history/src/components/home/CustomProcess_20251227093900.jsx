...
<div className="relative bg-[#E6F7F8] rounded-[40px] overflow-hidden flex flex-col md:flex-row items-stretch mb-20 min-h-[450px]">
          ...
          <div 
            className="relative z-20 w-full md:w-[60%] p-10 md:p-16 flex flex-col justify-center items-start md:clip-path-torn shadow-2xl"
            style={{
              backgroundImage: `linear-gradient(to right, rgba(255,255,255,0.92), rgba(255,255,255,0.85)), url(${bgImage.src})`,
