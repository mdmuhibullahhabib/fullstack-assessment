  ...
  return (
    <section className="bg-white py-20 px-4 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ===== TOP SECTION ===== */}
        <div className="relative bg-[#E6F7F8] rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch mb-20 min-h-[480px]">
          
          {/* Left Side Content with bgImage and Torn Effect */}
          <div 
            className="relative z-20 w-full md:w-[65%] p-10 md:p-16 flex flex-col justify-center items-start md:clip-path-torn shadow-xl"
            style={{
              backgroundImage: `linear-gradient(to right, rgba(255,255,255,0.9), rgba(255,255,255,0.7)), url(${bgImage.src})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              backgroundColor: 'white'
            }}
          >
            <span className="inline-block border border-teal-400 text-teal-500 text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-6 bg-white/50">
              Process
            </span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-800 leading-[1.1] mb-6">
            ...
            <button className="border-2 border-teal-500 text-teal-600 px-10 py-3 rounded-lg font-bold text-sm hover:bg-teal-500 hover:text-white transition-all uppercase tracking-wide">
              Learn More
            </button>
          </div>

          {/* Right Side Image (Hanging clothes) */}
          <div className="w-full md:w-[35%] flex items-center justify-center p-6 md:p-0">
            <div className="relative w-full h-[350px] md:h-[450px] transform md:scale-110">
              <Image
                src={rightImage}
          ...
          {/* <style jsx>{`
            @media (min-width: 768px) {
              .md\:clip-path-torn {
                /* Aggressive torn edge effect */
                clip-path: polygon(
                  0% 0%, 92% 0%, 100% 6%, 90% 14%, 98% 22%, 91% 33%, 100% 42%, 
                  93% 54%, 100% 65%, 90% 76%, 97% 88%, 91% 100%, 0% 100%
                );
              }
            }
          `}</style> */}
