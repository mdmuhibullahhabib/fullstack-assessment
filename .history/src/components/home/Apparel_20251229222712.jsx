              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="bg-teal-00 flex-1 flex items-center justify-center gap-2 border border-teal-500 text-teal-600 text-sm font-medium py-2 rounded-md hover:bg-teal-50 transition"
                  >
                    Add To Cart
                  </button>
