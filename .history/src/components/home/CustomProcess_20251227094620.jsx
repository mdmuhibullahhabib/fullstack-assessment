    ...
    return (
        <section className="bg-white py-20 px-4 font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
<div className="relative bg-[#E6F7F8] rounded-[40px] overflow-hidden flex flex-col md:flex-row items-stretch mb-20 min-h-[450px]">

  {/* ===== LEFT CONTENT (BG IMAGE) ===== */}
  <div
    className="relative w-full md:w-[60%] p-10 md:p-16 flex flex-col justify-center items-start"
    style={{
  ...
  >
    ...
    <div className="relative z-10">
      <div className="mb-6">
        <span className="px-5 py-1.5 rounded-full border border-teal-200 text-teal-500 text-[11px] font-bold uppercase tracking-[0.2em] bg-white/60">
          Process
        </span>
      </div>
      ...
      <button className="border border-teal-400 text-teal-500 px-8 py-2.5 rounded-md font-bold text-xs hover:bg-teal-500 hover:text-white transition-all">
        Learn More
      </button>
    </div>
  </div>

  {/* ===== RIGHT IMAGE (NO DIVIDER FEEL) ===== */}
  <div className="w-full md:w-[40%] relative flex items-center justify-center py-10">
    <div className="relative w-[85%] h-[360px] md:h-[420px]">
      <Image
        src={rightImage}
