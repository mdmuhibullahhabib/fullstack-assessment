    ...
    return (
        <section className="bg-white py-20 px-4 font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
                <div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:flex-row items-stretch mb-2 min-h-[450px]">
                    ...
                    >
                        ...
                        >
                            ...
                            <h3 className="text-3xl md:text-[40px] font-bold text-[#1a2b3c] leading-[1.2] mb-6">
