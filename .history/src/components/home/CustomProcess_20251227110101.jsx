...
export default function CustomProcess() {
    ...
    return (
        ...
        <button className="mt-auto block border-[1.5px] border-teal-400 text-teal-500 px-8 py-2.5 rounded-md font-bold text-xs hover:bg-teal-500 hover:text-white transition-all">
        Learn More
      </button>
                        </div>
                    </div>
