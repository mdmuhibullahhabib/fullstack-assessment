    ...
    return (
        <section className="bg-white py-20  font-sans">
            <div className=" mx-auto">
                ...
                {/* ===== TOP SECTION ===== */}
                <div className="relative bg-[#E6F7F8] overflow-hidden flex flex-col md:pl-8 md:py-[60px]  md:flex-row items-stretch mb-20 ">

                    {/* Left Content Box (White with bgImage and Torn Edge) */}
 <div
  className="relative w-full md:w-[60%] px-10 py-10 md:pl-5 flex flex-col justify-center items-start"
  style={{
...
>
  <div className="ml-12 md:ml-16">
    ...
    {/* Process Badge */}
    <div className="mb-2">
      <span className="px-4 py-1 rounded-full border border-teal-200 text-teal-500 text-[11px] font-bold uppercase tracking-[0.2em] bg-white/70">
        Process
      </span>
    </div>

    <h3 className="text-3xl md:text-4xl font-bold text-[#1a2b3c] leading-[1.2] mb-5">
      Do You Want Custom Project With Textilery? Contact Us Now
    </h3>

    <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-xl mb-7">
