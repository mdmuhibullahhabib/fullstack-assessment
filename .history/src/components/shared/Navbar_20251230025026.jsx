      ...
      <header className="w-full">
        ...
        <div className="bg-[#4cb5b0] text-white text-xs md:text-[13px] font-medium border-b border-white/10">
          <div className="max-w-6xl mx-auto flex justify-between items-center h-10 px-4">
            ...
            {/*  Social Icons */}
      <div className="relative h-full flex items-center justify-center md:justify-start md:mr-8">
  
  {/* White background bar (hide on mobile) */}
  <div className="hidden md:block absolute right-0 top-0 bottom-[-2px] md:w-[115px] bg-white origin-top-right transform translate-x-4"></div>

  {/* Social Icons */}
  <div className="relative flex items-center gap-4 text-[#ee4b22] md:ml-8">
    <FaFacebookF />
    <FaTwitter />
    <FaInstagram />
    <FaYoutube />
