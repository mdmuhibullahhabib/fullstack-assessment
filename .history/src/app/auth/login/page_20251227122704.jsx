...
const LoginLayout = () => {
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-[850px] min-h-[550px] rounded-[45px] shadow-2xl overflow-hidden flex flex-col bg-gradient-to-b from-[#07B4B0] via-[#07B4B0] via-[#ccf5f0] to-white border border-white/20">
          ...
          <div className="w-full max-w-[420px] space-y-4">
            ...
            <div className="relative group">
              ...
              <input 
                type="email" 
                placeholder="Email" 
                className="w-full bg-white border border-transparent rounded-[14px] py-4 pl-12 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#00bfa5]/20 placeholder-gray-400 transition-all shadow-sm"
              />
            </div>
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white border border-transparent rounded-[14px] py-4 pl-12 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-[#00bfa5]/20 placeholder-gray-400 transition-all shadow-sm"
              />
              <Eye className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4 cursor-pointer hover:text-[#00bfa5]" />
            </div>

            <div className="flex justify-end pr-1">
              <button className="text-[11px] font-bold text-gray-600 hover:text-[#00bfa5] transition-colors">
                Forget Password?
              </button>
            </div>

            {/* Log In Button */}
            <button className="w-full py-4 bg-[#00bfa5] text-white font-bold rounded-[14px] shadow-lg shadow-[#00bfa5]/20 hover:bg-[#00a892] active:scale-[0.98] transition-all">
              Log In
            </button>
            ...
            <div className="grid grid-cols-3 gap-4">
              <button className="flex justify-center items-center py-3 bg-white border border-gray-100 rounded-[14px] shadow-sm hover:border-[#00bfa5]/30 transition-all">
